...
int main() {
  ...
  mesh->AddPolygon({v4->HalfEdgeTo(v3), v3->HalfEdgeTo(v1), v1->HalfEdgeTo(v4)},
                   "P431");
  mesh->AddPolygon({v5->HalfEdgeTo(v4), v4->HalfEdgeTo(v2), v2->HalfEdgeTo(v5)},
                   "P542");
  mesh->AddPolygon({v3->HalfEdgeTo(v5), v5->HalfEdgeTo(v0), v0->HalfEdgeTo(v3)},
                   "P350");
  Print(mesh);
