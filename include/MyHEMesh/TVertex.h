...
class TVertex {
 ...
 public:
  ...
  static H* const HalfEdgeAlong(V* origin, V* end) noexcept {
  ...
  const E* const EdgeWith(const V* v) const noexcept {
    return const_cast<TVertex*>(this)->EdgeWith(const_cast<V*>(v));
  }

  static E* const EdgeBetween(V* v0, V* v1) noexcept {
  ...
  static bool IsConnected(const V* v0, const V* v1) noexcept {
