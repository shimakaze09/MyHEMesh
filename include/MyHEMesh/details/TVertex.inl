...
class VertexAdjEdgeView
    : public TLoopViewBase<VertexAdjEdgeView<IsConst, Traits>,
                           HEMeshTraits_PtrH<IsConst, Traits>,
                           HEMeshTraits_PtrE<IsConst, Traits>> {
 ...
 public:
  using TLoopViewBase<VertexAdjEdgeView<IsConst, Traits>, PtrH,
                      PtrE>::TLoopViewBase;
};
...
class VertexAdjVertexView
    : public TLoopViewBase<VertexAdjEdgeView<IsConst, Traits>,
                           HEMeshTraits_PtrV<IsConst, Traits>,
                           HEMeshTraits_PtrV<IsConst, Traits>> {
  using PtrH = HEMeshTraits_PtrH<IsConst, Traits>;
...
VertexAdjEdgeView<true, Traits> TVertex<Traits>::AdjEdges() const {
  return reinterpret_cast<VertexAdjEdgeView<true, Traits>&&>(
      const_cast<TVertex*>(this)->AdjEdges());
}
...
VertexAdjVertexView<true, Traits> TVertex<Traits>::AdjVertices() const {
  return reinterpret_cast<VertexAdjVertexView<true, Traits>&&>(
      const_cast<TVertex*>(this)->AdjVertices());
}
