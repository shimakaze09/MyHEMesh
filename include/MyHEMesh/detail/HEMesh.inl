...
template <typename V>
template <typename... Args>
typename HEMesh<V>::P* const HEMesh<V>::AddPolygon(
...
template <typename V>
const std::vector<std::vector<typename HEMesh<V>::HE*>>
HEMesh<V>::Boundaries() {
...
template <typename V>
template <typename... Args>
typename HEMesh<V>::E* const HEMesh<V>::ConnectVertex(HE* he0, HE* he1,
                                                      Args&&... args) {
  auto p = he0->Polygon();
  if (p != he1->Polygon()) {
    printf(
