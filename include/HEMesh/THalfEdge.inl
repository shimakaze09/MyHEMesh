...
template <typename V, typename E, typename P>
const HEMesh_ptr<THalfEdge<V, E, P>, HEMesh<V>>
THalfEdge<V, E, P>::FindFreeIncident(ptr<HE> begin, ptr<HE> end) {
...
THalfEdge<V, E, P>::NextBetween(ptr<HE> begin, ptr<HE> end) {
...
template <typename V, typename E, typename P>
const std::vector<HEMesh_ptr<THalfEdge<V, E, P>, HEMesh<V>>>
THalfEdge<V, E, P>::RotateNextBetween(ptr<HE> begin, ptr<HE> end) {
  std::vector<ptr<HE>> hes;
  auto he = begin;
  do {
    hes.push_back(he);
